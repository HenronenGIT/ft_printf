...
int	main(void)
{
	...
	printf("~%d~\n", PRINTER("|%.10lf|", 42.44214214122412)); fflush(stdout);
	printf("~%d~\n", PRINTER("|%.10Lf|", 42.1412441241421244211242412L)); fflush(stdout);
	...
	// printf("~%d~\n", PRINTER("|%.98132911124214244124214244124214244124214244124214244124214244124214244124214244124214244124214244124214244124214244124214244124214244124214244124214244124214244124214244124214244124214244124214244f|", 424124.412421142)); fflush(stdout);
